     <aside class="lg:sticky lg:top-6 lg:self-start lg:w-[300px] xl:w-[340px] flex-shrink-0">
         <div class="bg-surface/80 backdrop-blur-sm rounded-2xl p-6 border border-border shadow-xl">
             ...
             <!-- Profile photo -->
             <div class="w-24 h-24 rounded-full bg-accent/20 border-2 border-accent/30 overflow-hidden mb-5">
                 <img src="https://ui-avatars.com/api/?name=Firman+Syahputra&size=96&background=38BDF8&color=fff&font-size=0.5&bold=true"
                     alt="Firman Syahputra profile photo" class="w-full h-full object-cover" loading="lazy" width="96"
                     height="96" />
             </div>

             <!-- Name & role -->
             <h1 class="text-2xl font-bold tracking-tight text-primaryText">Firman Syahputra</h1>
             <p class="text-sm font-medium text-accent/90 mt-0.5">Senior Software Engineer</p>

             <!-- short description -->
             <p class="text-secondary-text text-sm leading-relaxed mt-3 max-w-xs">
                 Building resilient systems &amp; elegant interfaces. 10+ years of full‑stack craftsmanship.
             </p>
             ...
             <div class="mt-6 pt-5 border-t border-border flex items-center gap-4 flex-wrap">
                 <a href="#" class="text-secondary-text hover:text-accent transition-colors text-sm"
